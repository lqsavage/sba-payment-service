...
import com.iihtibm.sba.service.PaymentService;
...
public class PaymentController {
	...
	@ApiOperation(value = "Add payment details", response = com.iihtibm.sba.model.ApiResponse.class)
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successfully performed the operation"),
			@ApiResponse(code = 503, message = "Service Unavailable")
	})
	@PostMapping("/addPayment")
	public com.iihtibm.sba.model.ApiResponse<?> addPayment(
			@ApiParam(value = "Payment object which needs to add", required = true) @Valid @RequestBody Payment payment) {

		return new com.iihtibm.sba.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.payment.add"),
   ...
   */
	...
	@ApiOperation(value = "Update payment commission details", response = com.iihtibm.sba.model.ApiResponse.class)
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successfully performed the operation"),
			@ApiResponse(code = 404, message = "Resource Not Found"),
			@ApiResponse(code = 503, message = "Service Unavailable")
	...
	public com.iihtibm.sba.model.ApiResponse<?> updatePayment(
		...
		return new com.iihtibm.sba.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.payment.commission.update"),
